                        ...
                        <ul class="section-contacts-nav">
                            <li class="section-contacts-item">
                                ...
                                <div class="section-contacts-info">
                                    <span class="section-contacts-text">You can call us 24/7</span>
                                    <a href="tel:+8801983-091400" class="section-contacts-link">+8801983-091400</a>
                                    <a href="tel:+8801952-763885" class="section-contacts-link">+8801952-763885</a>
                                </div>
                            </li>
                            <li class="section-contacts-item">
                                ...
                                <div class="section-contacts-info">
                                    ...
                                    <a href="https://goo.gl/maps/6A5JwPPCHRB4WD6E8" class="section-contacts-link">Level 6-7, Daffodil Plaza,<br>4/2 Sobhanbag Rd, Dhaka 1207</a>
                                </div>
                            </li>
                            <li class="section-contacts-item">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                        <div class="section-contacts-form">
                             <form method="POST" action="sendmail.php" id="contactform" name="contactform">
                                ...
                                <input type="submit" class="btn btn-lg btn-r" value="SEND">
                            </form>
                        </div>
                    </div>
                </div>
