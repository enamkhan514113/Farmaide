                ...
                <form action="" id="user-form" class="py-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="type" id="type" class="form-select rounded-0" required>
                            ...
                            <option class="px-2 py-2" value="2" <?= isset($type) && $type == 2 ? 'selected': '' ?>>Seller</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group mb-3 d-flex justify-content-center">
                        <img src="http://localhost/farmaide/omps/uploads/users/avatar-7.png" alt="" id="cimg" class="img-fluid img-thumbnail">
                    </div>
                    <div class="row">
