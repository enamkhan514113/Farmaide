    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center mb-4">
                <img class="img-thumbnails border product-thumbnail" src="<?= validate_image((isset($title) && is_file(base_app."uploads/thumbnails/$title.png")) ? "uploads/thumbnails/$title.png?v=".(strtotime($date_updated)): "") ?>" alt="<?= isset($title) ? $title : "" ?>">
            </div>
        </div>
        ...
        <h3 class="text-center fw-bolder">বিক্রেতার তথ্য</h3>
        <center>
