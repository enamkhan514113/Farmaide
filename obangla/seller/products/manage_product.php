    ...
    <div class="container">
        ...
        <form action="" id="product-form">
			...
			<div class="form-group mb-3 d-flex justify-content-start">
				<img src="<?php echo validate_image((isset($title) && is_file(base_app."uploads/thumbnails/{$title}.png")) ? "uploads/thumbnails/{$title}.png?v=".(strtotime($date_updated)): "") ?>" alt="" id="cimg" class="img-fluid img-thumbnail">
			</div>
            <div class="form-group mb-3">
...
<script>
    function displayImg(input) {
	    if (input.files && input.files[0]) {
            ...
            $('#cimg').attr('src', '<?php echo validate_image((isset($title) && is_file(base_app."uploads/thumbnails/$title.png")) ? "uploads/thumbnails/$title.png?v=".(strtotime($date_updated)): "") ?>');
        }
	}
