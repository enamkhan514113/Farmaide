            ...
            <div class=" row">
                <div class="col-12">
                    <div class="text-center">
                        <p style="color:" class="<?= in_array($page,['login','registration']) ? "text-primary" : "text-dark" ?> my-4 text-sm font-weight-normal">
                            All rights reserved. Copyright © 2023 by Farmaide
                            <script>
                                <?= date('Y') ?>
                            </script>
                        </p>
