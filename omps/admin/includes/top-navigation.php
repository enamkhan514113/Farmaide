        ...
        <div class="row">
            <div class="col-12">
                <nav class="navbar navbar-expand-lg  blur border-radius-xl top-0 z-index-fixed shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
                    ...
                    <a class="navbar-brand font-weight-bolder ms-sm-3" href="http://localhost/farmaide/omps" rel="tooltip" title="Designed and Coded by Creative Tim" data-placement="bottom">
                        <img src="http://localhost/farmaide/omps/uploads/568436.png?v=1649727378" alt="header_logo" width="30">
                        <?= $_settings->info('short_name') ?>
                        </a>
                        <a class="navbar-brand font-weight-bolder ms-sm-3" href="http://localhost/farmaide" rel="tooltip" title="Designed and Coded by Creative Tim" data-placement="bottom">
                        MainSite
                        </a>
                            ...
                            <ul class="navbar-nav navbar-nav-hover ms-auto">
                                <li class="nav-item dropdown dropdown-hover mx-2">
                                    <a class="nav-link ps-2 d-flex cursor-pointer align-items-center <?= $page == "home" ? "text-primary" : "" ?>" href="./" aria-expanded="false">
                                        <i class="material-icons opacity-6 me-2 text-md">dashboard</i> Admin Dashboard
                                    </a>
                                </li>
                                <li class="nav-item dropdown dropdown-hover mx-2">
...
-->
                                ...
                                <li class="nav-item my-auto ms-3 ms-lg-0">
                                    <a class="nav-link ps-2 d-flex cursor-pointer align-items-center" id="dropdownMenuUser" data-bs-toggle="dropdown" aria-expanded="false">
                                        <span><img src="http://localhost/farmaide/omps/uploads/users/avatar-7.png" alt="<?= $_settings->userdata('username') ?> Image" class="image-user img-thumbnail rounded-circle"></span>
                                        Hello, <?= $_settings->userdata('username') ?>
                                        <img src="http://localhost/Farmaide/omps/assets/img/down-arrow-dark.svg" alt="down-arrow" class="arrow ms-auto ms-md-2">
                                    </a>
